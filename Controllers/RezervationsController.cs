...
namespace Spacentar.Controllers
{
    public class RezervationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdClient,IdProcedure,DateProcedure")] Rezervation rezervation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdClient,IdProcedure,DateProcedure")] Rezervation rezervation)
        {
